...
describe("display", () => {
  ...
  test("imageOsReleasePrettyName fact takes priority over testResult.targetOS", async () => {
    ...
    scanResultWithOsFact.facts.find(f => f.type === 'imageOsReleasePrettyName')!.data = "Red Hat Enterprise Linux 8.2 (Ootpa)";
  ...
  test("handles empty imageOsReleasePrettyName fact data gracefully", async () => {
    ...
    scanResultWithEmptyFact.facts.find(f => f.type === 'imageOsReleasePrettyName')!.data = "";
  ...
  test("handles null imageOsReleasePrettyName fact data gracefully", async () => {
    ...
    scanResultWithNullFact.facts.find(f => f.type === 'imageOsReleasePrettyName')!.data = null;
