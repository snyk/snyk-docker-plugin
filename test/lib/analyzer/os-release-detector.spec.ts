...
describe("OS Release Analyzer functions", () => {
  describe("tryOSRelease", () => {
    it("should return null for empty text", async () => {
      const { tryOSRelease } = await import("../../../lib/analyzer/os-release/release-analyzer");
    ...
    it("should throw error when ID is missing", async () => {
      ...
      await expect(tryOSRelease(text)).rejects.toThrow("Failed to parse /etc/os-release");
    });
  ...
  describe("tryLsbRelease", () => {
    it("should return null for empty text", async () => {
      const { tryLsbRelease } = await import("../../../lib/analyzer/os-release/release-analyzer");
    ...
    it("should throw error when DISTRIB_ID is missing", async () => {
      ...
      await expect(tryLsbRelease(text)).rejects.toThrow("Failed to parse /etc/lsb-release");
    });
  ...
  describe("tryDebianVersion", () => {
    it("should return null for empty text", async () => {
      const { tryDebianVersion } = await import("../../../lib/analyzer/os-release/release-analyzer");
    ...
    it("should throw error for very short version", async () => {
      const { tryDebianVersion } = await import("../../../lib/analyzer/os-release/release-analyzer");
      const text = "9";
      await expect(tryDebianVersion(text)).rejects.toThrow("Failed to parse /etc/debian_version");
    });
  ...
  describe("tryAlpineRelease", () => {
    it("should return null for empty text", async () => {
      const { tryAlpineRelease } = await import("../../../lib/analyzer/os-release/release-analyzer");
  ...
  describe("tryRedHatRelease", () => {
    it("should return null for empty text", async () => {
      const { tryRedHatRelease } = await import("../../../lib/analyzer/os-release/release-analyzer");
    ...
    it("should throw error for unparseable format", async () => {
      ...
      await expect(tryRedHatRelease(text)).rejects.toThrow("Failed to parse /etc/redhat-release");
    });
  ...
  describe("tryCentosRelease", () => {
    it("should return null for empty text", async () => {
      const { tryCentosRelease } = await import("../../../lib/analyzer/os-release/release-analyzer");
    ...
    it("should throw error for unparseable format", async () => {
      ...
      await expect(tryCentosRelease(text)).rejects.toThrow("Failed to parse /etc/centos-release");
    });
  ...
  describe("tryOracleRelease", () => {
    it("should return null for empty text", async () => {
      const { tryOracleRelease } = await import("../../../lib/analyzer/os-release/release-analyzer");
    ...
    it("should throw error for unparseable format", async () => {
      ...
      await expect(tryOracleRelease(text)).rejects.toThrow("Failed to parse /etc/oracle-release");
    });
