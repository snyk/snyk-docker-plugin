...
test("analyze", async (t) => {
  ...
  const examples = [
    ...
    },
    {
      ...
      dpkgManifestLines: ["Package: La-Croix", "Version: Lime"],
      extManifestLines: [],
      expectedPackages: [
    ...
    },
    {
      ...
      dpkgManifestLines: ["Package: La-Croix", "Version: Lime+extra_lime"],
      extManifestLines: [],
      expectedPackages: [
    ...
    {
      description: "Source",
      dpkgManifestLines: ["Package: zlib1g", "Source: libz1"],
      extManifestLines: [],
      expectedPackages: [
        {
          ...defaultPkgProps,
