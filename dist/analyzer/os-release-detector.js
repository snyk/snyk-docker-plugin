...
exports.OS_VERPATHS = OS_VERPATHS;
function detect(docker, dockerfileAnalysis) {
...
function tryOSRelease(docker) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const text = (yield tryRelease(docker, "/usr/lib/os-release")) ||
            (yield tryRelease(docker, "/etc/os-release"));
        if (!text) {
            return null;
        }
...
function tryRelease(docker, release) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        try {
            return yield docker.getTextFile(release);
        }
        catch (error) {
